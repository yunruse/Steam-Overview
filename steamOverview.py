...
def _getPaths(log):
    def logPath(path): return log("Trying '{}'…", path)
    ...
    while len(paths) == 0:
        if attempts == 0:
            ...
            print(
                "Still couldn't find anything, sorry. The install directory should contain")
...
def slottableToDict(obj): return {key: getattr(obj, key)
